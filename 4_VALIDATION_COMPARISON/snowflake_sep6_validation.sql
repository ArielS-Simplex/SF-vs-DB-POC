-- ==============================================================================
-- SNOWFLAKE VALIDATION QUERIES - September 6, 2025
-- Compare against Databricks silver table for same date
-- ==============================================================================
...
SELECT 
    'SNOWFLAKE_ROW_COUNT_SEP6' AS check_type,
    COUNT(*) AS total_rows,
...
SELECT 
    'SNOWFLAKE_BUSINESS_LOGIC_SEP6' AS check_type,
...
SELECT 
    'SNOWFLAKE_TRANSACTION_TYPES_SEP6' AS check_type,
    transaction_type,
...
SELECT 
    'SNOWFLAKE_CLIENT_BREAKDOWN_SEP6' AS check_type,
    multi_client_name,
...
SELECT 
    'SNOWFLAKE_AUTH_FLOW_SEP6' AS check_type,
    authentication_flow,
    COUNT(*) AS total_count,
...
SELECT 
    'SNOWFLAKE_CURRENCY_AMOUNTS_SEP6' AS check_type,
    currency_code,
    COUNT(*) AS transaction_count,
...
SELECT 
    'SNOWFLAKE_DATA_QUALITY_SEP6' AS check_type,
    data_quality_flag,
    date_quality_flag,
